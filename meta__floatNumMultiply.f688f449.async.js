...
const Demo = () => {
  ...
  return (
    <div>
      ...
      <p>
        floatNumMultiply{floatNumMultiply(Number(numbers.a), Number(numbers.b))}
      </p>
    </div>
  );
};
...
export default Demo;
`},68342:function(u,e){e.Z=`const floatNumMultiply = (a = 0, b = 0) => {
  let m = 0;
  const c = a.toString();
  const d = b.toString();
